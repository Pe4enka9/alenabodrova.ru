@extends('theme')
@section('title', 'Студия красоты А. Бодровой')
@section('style', asset('css/index-style.css'))
@section('content')
    <section class="welcome">
        <div class="rect">
            <div class="gradient">
                <p class="welcome-main-text nocopy">На первое посещение скидка 20% на все услуги парикмахерского
                    зала</p>
                <a href="/create">
                    <button class="welcome-make-order">Записаться</button>
                </a>
            </div>
